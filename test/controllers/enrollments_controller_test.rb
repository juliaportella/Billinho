  ...
  test 'should create enrollment' do
    assert_difference('Enrollment.count') do
      post enrollments_url,
           params: { enrollment: { course: @enrollment.course, course_value: @enrollment.course_value,
                                   due_day: @enrollment.due_day, institution_id: @enrollment.institution_id, quantity_bills: @enrollment.quantity_bills, student_id: @enrollment.student_id } }
    end
