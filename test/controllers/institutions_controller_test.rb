...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create institution' do
    assert_difference('Institution.count') do
      post institutions_url,
           params: { institution: { cnpj: @institution.cnpj, modality: @institution.modality,
  ...
  test 'should update institution' do
    patch institution_url(@institution),
          params: { institution: { cnpj: @institution.cnpj, modality: @institution.modality, name: @institution.name } }
